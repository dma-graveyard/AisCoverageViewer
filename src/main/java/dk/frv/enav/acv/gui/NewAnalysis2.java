...
public class NewAnalysis2 extends JFrame implements KeyListener {
	...
	public NewAnalysis2(final AnalysisPanel ap) {
		lowTxt.setText("5");
		lowTxt.setBounds(66, 61, 86, 20);
		lowTxt.setColumns(10);
		mediumTxt.setText("15");
		mediumTxt.setBounds(66, 36, 86, 20);
		...
		tabbedPane.setSize(new Dimension(369, 399));
		...
		// text area
		scrollPane.setBounds(14, 37, 340, 79);
		...
		// select file button
		btnSelectFile.setBounds(265, 127, 89, 23);
		...
		classABPanel.setBounds(14, 157, 340, 56);
		...
		shipTypePanel.setBounds(14, 224, 340, 136);
		...
		chckbxIncludeAll.setBounds(6, 16, 328, 23);
		shipTypePanel.add(chckbxIncludeAll);

		scrollPane_1.setBounds(16, 46, 314, 79);
		...
		advancedSettingsPanel.setBounds(10, 79, 344, 74);
		...
		lblMessageBuffer.setBounds(10, 14, 96, 14);
		advancedSettingsPanel.add(lblMessageBuffer);

		messageBufferTxt = new JTextField();
		messageBufferTxt.setBounds(106, 11, 44, 20);
		...
		lblSekunder.setBounds(160, 14, 46, 14);
		advancedSettingsPanel.add(lblSekunder);
		chckbxIncludeTurningShips.setBounds(6, 35, 167, 23);
		advancedSettingsPanel.add(chckbxIncludeTurningShips);

		rotationTxt = new JTextField();
		rotationTxt.setBounds(177, 36, 46, 20);
		...
		lblDegrees.setBounds(228, 36, 96, 14);
		...
		chckbxCoverageAdvancedSettings.setBounds(10, 58, 186, 23);
		...
		higMedLowPanel.setBounds(10, 47, 344, 106);
